import { DAZZLING_COLOURS, ICONS, UI_VALUE_HEIGHT, WINDOW_WIDTH } from "../../constants";
import { awardsInfo, TAward } from "../../data/awards-info";
...
export const initAwards = (changeColourBack: Function) => {
