...
export const awardsInfo: TAward[] = [
  {
    name: "mostTidy",
		text: "Most tidy park",
    positive: true,
		requirements: ["More than 1/64 of guests think how tidy the park is", "Fewer than 6 guests think the park is untidy"],
  ...
  },
  {
    ...
    positive: false,
		requirements: ["More than 1/16 of guests thinking about litter, vandalism or disgusting path"],
  ...
  },
  {
    ...
    positive: true,
		requirements: ["Have 6 open rollercoasters with no recent crashes"],
    exclusion: [],
  },
  {
    name: "bestValue",
    ...
    positive: true,
		requirements: ["Must have an entrance fee", "Scenario must be using money", "Entrance fee is 0.1 less than half the total ride value for money"],
  ...
  },
  {
    ...
    positive: true,
		requirements: ["More than 1/128 of guests think the scenery is great", "Fewer than 16 think how untidy the park is"],
    exclusion: ["mostUntidy", "mostDisappointing"],
  },
  {
    name: "worstValue",
  ...
  },
  {
    name: "safest",
		text: "Safest park",
    positive: true,
		requirements: ["2 or fewer think the vandalism is bad", "No recent crashes"],
    exclusion: [],
  },
  {
    name: "bestStaff",
		text: "Best staff",
    positive: true,
		requirements: ["At least 20 staff", "At least 1 of each staff type", "One member of staff per 32 guests"],
  ...
  },
  {
    name: "bestFood",
		text: "Best food",
    positive: true,
		requirements: ["At least 7 food shops", "4 different types of food shops", "One food shop per 128 guests", "No more than 12 hungry guests"],
    exclusion: ["worstFood"],
  },
  {
    name: "worstFood",
  ...
  },
  {
    name: "bestToilets",
		text: "Best toilets",
    positive: true,
		requirements: ["At least 4 toilets", "One toilet per 128 guests", "No more than 16 guests think they need the toilet"],
    exclusion: [],
  },
  {
    ...
    positive: false,
		requirements: ["Park rating 650 or less", "More than half of rides have popularity rating below 6"],
    exclusion: ["bestValue"],
  },
  {
    name: "bestWaterRides",
    ...
    positive: true,
		requirements: ["At least 6 active water rides that haven't crashed recently"],
    exclusion: [],
  },
  {
    ...
    positive: true,
		requirements: ["At least 6 custom built rides with excitement of 5.5 or higher"],
    exclusion: [],
  },
  {
  ...
  },
  {
    ...
    positive: false,
		requirements: ["At least 10 guests are lost or can't find a ride", "More than 1/64 of guests are lost or can't find a ride"],
    exclusion: [],
  },
  {
